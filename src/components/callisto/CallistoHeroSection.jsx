...
const CallistoHeroSection = () => {
  const scrollToPlayers = () => {
    const element = document.getElementById('callisto-players');
    if (element) {
  ...
  return (
    <section id="callisto-home" className="callisto-hero-section flex items-center justify-center relative">
      <div className="container mx-auto px-4 text-center z-10">
        ...
        <div className="mb-8 float-animation">
          <img 
            ...
            className="h-32 md:h-48 mx-auto rounded-full"
          />
        </div>

        {/* Título Principal */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
          <span className="callisto-text-gradient">Lua Callisto</span>
        </h1>
...
export default CallistoHeroSection;
